...
public class BuyLocallyExcelHelper {
    ...
    static String[] HEADERs = {"Vào sổ", "Ghi sổ", "Loại mua hàng", "Phương thức thanh toán", "Hình thức mua hàng",
        "Lập kèm hóa đơn", "Đã nhận hóa đơn", "Số chứng từ", "Số phiếu nhập", "Số CT thanh toán", "Ngày chứng từ",
        "Ngày hạch toán", "Loại tiền", "Tỷ giá", "Mã đối tượng", "Tên đối tượng", "Địa chỉ", "Mã số thuế", "Người giao",
        "Hạn thanh toán", "Diễn giải", "Mã nhân viên", "Kèm theo", "Tài khoản trả", "Tài khoản nhận", "Mẫu số HĐ",
        "Ký hiệu HĐ", "Số HĐ", "Ngày HĐ", "Mã hàng", "Tên hàng", "Là chi phí mua hàng", "Kho", "TK Nợ", "TK Có",
        "ĐT hạch toán", "ĐVT", "Số lượng", "Đơn giá", "Đơn giá QĐ", "Thành tiền", "Thành tiền QĐ", "Tỷ lệ CK", "Tiền CK",
        "Tiền CK QĐ", "Chi phí mua", "Chi phí trước HQ", "Giá nhận", "Số lô", "Hạn dùng",
        "Diễn giải thuế", "Giá tính thuế", "% thuế NK", "Tiền thuế NK", "TK thuế NK", "% thuế TTĐB", "Tiền thuế TTĐB",
        "TK thuế TTĐB", "% thuế GTGT", "Tiền thuế GTGT", "Tiền thuế GTGT QĐ", "TK thuế GTGT", "TKĐƯ thuế GTGT", "Mẫu số HĐ (HT)",
        "Ký hiệu HĐ (HT)", "Số HĐ (HT)", "Ngày HĐ (HT)", "Nhóm HHDV mua vào", "Khoản mục CP", "Đối tượng THCP", "Hợp đồng",
