...
public class SyntheticDTO {
    ...
    public SyntheticDTO(
        ...
        String currencyType,
        BigDecimal currency,
        String materialGoodCode,
        String materialGoodName,
        String storageIn,
        String storageOut,
        String caculationUnit,
        Float amount,
        BigDecimal price,
        BigDecimal tranferRate,
        BigDecimal moneyTranfer,
        String fixedAssetsType,
        ...
        BigDecimal currencyTax,
        Integer taxPercent,
        String debitAccountTax,
        String creditAccountTax,
        String debitAccountXK,
        String creditAccountXK,
        BigDecimal currencyXK,
        BigDecimal priceXK,
        String voucherNoXK
    ) {
        this.id = id;
